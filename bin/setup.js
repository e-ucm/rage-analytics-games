...
if (process.env.NODE_ENV === 'test') {
    ...
    Async.auto({
        ...
        projectName: function (done) {
            ...
            var promptOptions = {
                default: defaultValues.projectName || 'Rage Analytics Games'
            };
        ...
        secretKey: ['companyName', function (done) {

            var promptOptions = {
                default: defaultValues.secretKey || 'testkey'
            };

            Promptly.prompt('Secret key: (' + promptOptions.default + ')', promptOptions, done);
        }],
        port: ['secretKey', function (done) {

            var promptOptions = {
                default: defaultValues.port || 3450
            };
